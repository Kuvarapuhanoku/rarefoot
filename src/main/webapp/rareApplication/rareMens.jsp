    ...
    >
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img
            class="curouselImg"
            src="AppImages/jordan-curousel.png"
            class="d-block w-100"
            alt="jordanoffer"
          />
        </div>
...
<%
    ...
    <div class="brandsAndProductsContainer">
      <div class="brandsContainer">
        <h4 class="brandHead">Brands</h4>
        <div class="oneBrandContainer">
        <form action="rareFilter?page=rareMens.jsp" method="post">
          <div class="onebrand">
          <input
            type="radio"
            class="brandCheckBox"
            ...
            name="brand"
          />
          <label for="airjordan" class="checkLabel">Air Jordan</label>
          </div>
          <div class="onebrand">
          <input
            type="radio"
            ...
            name="brand"
          />
          <label for="louis vuitton" class="checkLabel">Louis Vuitton</label>
          </div>
          <div class="onebrand">
          <input
            type="radio"
            ...
            name="brand"
          />
          <label for="All" class="checkLabel">All</label>
          </div>
        </div>
        <input class="filter" width="20vw" type="submit" value="Filter">
          </form>
      </div>
...
<%for(ProductDto l: allProducts){ 
	...
	String filterbrand;
	try{
		ProductDto brandElement = (ProductDto) session.getAttribute("brand");
		filterbrand = brandElement.getBrand();
